            ...
            <div class="container">
              <div class="row sidebar-area footer-area">
                <div id="categories-2" class="col-lg-3 col-md-6 widget_categories">
                    <h4 class="title"><?php esc_html_e('Categories', 'lms-education-university'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="pages-2" class="col-lg-3 col-md-6 widget_pages">
                    <h4 class="title"><?php esc_html_e('Pages', 'lms-education-university'); ?></h4>
                    <ul>
                        <?php
                        wp_list_pages(array(
                            'title_li' => '',
                ...
                <div id="archives-2" class="col-lg-3 col-md-6 widget_archive">
                    <h4 class="title"><?php esc_html_e('Archives', 'lms-education-university'); ?></h4>
                    <ul>
                        <?php
                ...
                <div id="calendar" class="col-lg-3 col-md-6 widget_calendar">
                  <h4 class="title"><?php esc_html_e('Calendar', 'lms-education-university'); ?></h4>
                  <?php get_calendar(); ?>
                </div>
              </div>
            </div>
          ...
          <div class="copy-text">
            <p class="mb-0 py-3">
              <?php
                ...
                <a href="<?php echo esc_url('https://www.misbahwp.com/products/free-university-wordpress-theme'); ?>" target="_blank">
