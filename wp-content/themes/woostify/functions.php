...
// WooCommerce files (only load if WooCommerce is activated).
if ( class_exists( 'WooCommerce' ) ) {
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/woocommerce/class-woostify-woocommerce.php' ) ) {
        require_once WOOSTIFY_THEME_DIR . 'inc/woocommerce/class-woostify-woocommerce.php';
    }
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/woocommerce/class-woostify-adjacent-products.php' ) ) {
        require_once WOOSTIFY_THEME_DIR . 'inc/woocommerce/class-woostify-adjacent-products.php';
    }
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-template-functions.php' ) ) {
        require_once WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-template-functions.php';
    }
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-archive-product-functions.php' ) ) {
        require_once WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-archive-product-functions.php';
    }
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-single-product-functions.php' ) ) {
        require_once WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-single-product-functions.php';
    }
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/woocommerce/woostify-woocommerce-query-update.php' ) ) {
...
// Woostify admin.
if ( is_admin() ) {
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/admin/class-woostify-admin.php' ) ) {
        require_once WOOSTIFY_THEME_DIR . 'inc/admin/class-woostify-admin.php';
    }
    if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/admin/class-woostify-meta-boxes.php' ) ) {
        require_once WOOSTIFY_THEME_DIR . 'inc/admin/class-woostify-meta-boxes.php';
    }
}

// Compatibility.
if ( file_exists( WOOSTIFY_THEME_DIR . 'inc/compatibility/class-woostify-divi-builder.php' ) ) {
